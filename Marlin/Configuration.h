...
#define STRING_CONFIG_H_AUTHOR "Hoang Minh, Cetus-3" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Cetus-3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "a8868cdc-d27a-444a-bbe1-ea399d737abd"
...
#define DUMMY_THERMISTOR_999_VALUE 199
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  56.6
    #define DEFAULT_Ki  10.16
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 87.6
  #define DEFAULT_bedKi 16.21
  #define DEFAULT_bedKd 315.9
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 773	 }
...
#define Z_PROBE_SERVO_NR 0
  ...
  #define Z_SERVO_ANGLES { 130, 75 }      // Z Servo Deploy and Stow angles
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -21.5, 21.5, -0.20 }
